...
export default class CanvasRenderingContext2D {
	...
	set fillStyle(value) {
		...
		if (typeof(value) == 'string') {
			...
			var command = "D" + value._start_pos._x.toFixed(3) + "," + value._start_pos._y.toFixed(3) + "," +
				value._end_pos._x.toFixed(3) + "," + value._end_pos._y.toFixed(3) + "," +
				value._stop_count;
			...
			var command = "H" + value._start_pos._x.toFixed(3) + "," + value._start_pos._y.toFixed(3) + "," + value._start_pos._r
				.toFixed(3) + "," +
				value._end_pos._x.toFixed(3) + "," + value._end_pos._y.toFixed(3) + "," + value._end_pos._r.toFixed(3) + "," +
				value._stop_count;
			for (var i = 0; i < value._stop_count; ++i) {
				command += ("," + value._stops[i]._pos + "," + value._stops[i]._color);
			}
	...
	set globalAlpha(value) {
		...
		this._drawCommands = this._drawCommands.concat("a" + value.toFixed(3) + ";");
	}
	...
	setTransform(a, b, c, d, tx, ty) {
		this._drawCommands = this._drawCommands.concat("t" +
			...
			(b === 0 ? "0" : b.toFixed(3)) + "," +
			(c === 0 ? "0" : c.toFixed(3)) + "," +
			(d === 1 ? "1" : d.toFixed(3)) + "," + tx.toFixed(3) + "," + ty.toFixed(3) + ";");
	}
	...
	scale(a, d) {
		this._drawCommands = this._drawCommands.concat("k" + a.toFixed(3) + "," +
			d.toFixed(3) + ";");
	}
	...
	translate(tx, ty) {
		this._drawCommands = this._drawCommands.concat("l" + tx.toFixed(3) + "," + ty.toFixed(3) + ";");
	}
	...
	moveTo(x, y) {
		this._drawCommands = this._drawCommands.concat("g" + x.toFixed(3) + "," + y.toFixed(3) + ";");
	}

	lineTo(x, y) {
		this._drawCommands = this._drawCommands.concat("i" + x.toFixed(3) + "," + y.toFixed(3) + ";");
	}
	...
	bezierCurveTo(cp1x, cp1y, cp2x, cp2y, x, y, ) {
		this._drawCommands = this._drawCommands.concat(
			"z" + cp1x.toFixed(3) + "," + cp1y.toFixed(3) + "," + cp2x.toFixed(3) + "," + cp2y.toFixed(3) + "," +
	...
	arc(x, y, radius, startAngle, endAngle, anticlockwise) {
		...
		this._drawCommands = this._drawCommands.concat(
			"y" + x.toFixed(3) + "," + y.toFixed(3) + "," +
			radius.toFixed(3) + "," + startAngle + "," + endAngle + "," + ianticlockwise +
			";"
		);
	}
